...
std::vector<std::shared_ptr<Primitive>> Mesh::LoadObj(char const *fileName, std::shared_ptr<Shader> shader, Vec3 const &scale, Vec3 const &translation, bool flipU, bool flipV) {
